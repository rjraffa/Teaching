...
On a Mac, Place the file "OSC-ExampleWithSound.touchosc" from the zip file in the Documents/touchosc-default-layouts folder (not sure where the "touchosc-default-layouts" folder is on a PC so just search for that).
